...
structures = {"cube": {"vertices": vertices_cube, "edges": edges_cube, "faces": faces_cube},
              "pyramide": {"vertices": vertices_pyramide, "edges": edges_pyramide},
              "plan": {"vertices": vertices_plan, "edges": edges_plan}}
